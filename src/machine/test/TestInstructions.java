...
/**
 * A JUnit tester for all the ALT machine instructions.
 *
 * @author RIT CS
 */
...
public class TestInstructions {
    ...
    public void testPush() {
        ...
        String expected = "(ALT) Instruction stack:" + System.lineSeparator() +
    ...
    public void testPrint() {
        ...
        String expectedStack = "(ALT) Instruction stack:" + System.lineSeparator() +
        ...
        expectedStack = "(ALT) Instruction stack:" + System.lineSeparator() +
    ...
    public void testStore() {
        ...
        expected = "(ALT) Instruction stack:" + System.lineSeparator() +
    ...
    public void testPower() {
        ...
        Push push4 = new Push(4, machine);
        assertEquals("PUSH 4", push4.toString());
        Push push3 = new Push(3, machine);
        assertEquals("PUSH 3", push3.toString());
        Push push2 = new Push(2, machine);
        assertEquals("PUSH 2", push2.toString());

        push4.execute();
        push3.execute();
        push2.execute();

        Power pow3 = new Power(machine);
        assertEquals("POW", pow3.toString());
        pow3.execute();
        ...
        Power pow4 = new Power(machine);
        assertEquals("POW", pow4.toString());
        pow4.execute();

        assertEquals(1, machine.getInstructionStack().size());
        expected = "(ALT) Instruction stack:" + System.lineSeparator() +
                "\t0: 262144" + System.lineSeparator();
        assertEquals(expected, machine.getInstructionStack().toString());
    }
}
