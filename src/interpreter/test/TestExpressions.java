...
/**
 * A JUnit tester for all the NMU expressions.
 *
 * @author RIT CS
 */
...
public class TestExpressions {
    ...
    public void testBinaryOperation() {
        ...
        BinaryOperation pow1 = new BinaryOperation("^", new Constant(4), new Constant(3));
        ...
        outContent.reset();
        pow1.emit();
        assertEquals("( 4 ^ 3 )", outContent.toString());
        outContent.reset();
        ...
        assertEquals(64, pow1.evaluate(null));
        ...
        String expected = "PUSH 10" + System.lineSeparator() +
                ...
                "PUSH 4" + System.lineSeparator() +
                "PUSH 3" + System.lineSeparator() +
                "POW" + System.lineSeparator();
                assertEquals(expected, outContent.toString());
    }
}
